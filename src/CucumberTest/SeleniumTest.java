...
public class SeleniumTest {
	...
	public void i_have_launched_a_Firefox_Browser() throws Throwable {
	...
	public void i_have_added_an_item_to_my_cart() throws Throwable {
		...
		driver.findElement(By.xpath("//a[contains(text(),'iPhones')])")).click();
	...
	public void i_should_see_the_contents_of_the_cart_include_the_item() throws Throwable {
		...
		driver.findElement(By.xpath("//a[contains(text(),'Apple iPhone 4S 16GB SIM-Free - Black')]")).isDisplayed();
